...
$_seo = load_page_seo($_seoPdo, 'careers');
...
<main class="bg-background-dark">
	<section class="relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden pt-24 bg-black" style="background-image: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('public/assets/img/group-img.jpg'); background-size: cover; background-position: center; background-attachment: fixed;">
