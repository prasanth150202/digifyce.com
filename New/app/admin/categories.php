...
<div class="card border-0 mb-4">
	...
	<div class="card-body">
		<form method="post" action="category_save.php" class="row g-3">
			<div class="col-md-5">
			...
			<table class="table table-hover mb-0">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-end">
							<a href="category_delete.php?id=<?= $cat['id'] ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Delete category?')">
