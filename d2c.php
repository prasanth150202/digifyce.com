<?php
$pageTitle = 'D2C Marketing Service – Scale Direct-to-Consumer Brands';
$pageDescription = 'Digifyce drives D2C growth with performance marketing, paid media strategies, and conversion optimization for scalable brand success.';
...
<section class="py-32 px-6 lg:px-12 bg-[var(--navy-black)]">
    <div class="max-w-[1600px] mx-auto">
        <div class="mb-20">
            <span
                class="text-[var(--electric-blue)] font-bold tracking-[0.3em] text-[10px] uppercase mb-4 block">Quantifiable
                Comparison</span>
            <h2 class="text-6xl lg:text-8xl font-bold leading-[0.85] tracking-tighter mb-8">Industry Verticals &amp;
                Performance Benchmarks</h2>
            <p class="text-white/40 max-w-2xl text-lg">A multi-level analysis comparing standard agency performance
                against Digifyce's engineered approach.</p>
        </div>
        <!-- Filter Tags -->
        <div class="flex flex-wrap gap-4 mb-8">
            <button
                class="industry-filter-tag bg-[var(--electric-blue)]/10 text-[var(--electric-blue)] font-bold px-4 py-2 rounded-full text-xs uppercase tracking-widest border border-[var(--electric-blue)] transition-all hover:bg-[var(--electric-blue)] hover:text-white active"
                data-industry="all">All</button>
            <button
                class="industry-filter-tag bg-[var(--electric-blue)]/10 text-[var(--electric-blue)] font-bold px-4 py-2 rounded-full text-xs uppercase tracking-widest border border-[var(--electric-blue)] transition-all hover:bg-[var(--electric-blue)] hover:text-white"
                data-industry="apparel">Clothing & Apparel</button>
            <button
                class="industry-filter-tag bg-[var(--electric-blue)]/10 text-[var(--electric-blue)] font-bold px-4 py-2 rounded-full text-xs uppercase tracking-widest border border-[var(--electric-blue)] transition-all hover:bg-[var(--electric-blue)] hover:text-white"
                data-industry="fmcg">FMCG & CPG</button>
            <button
                class="industry-filter-tag bg-[var(--electric-blue)]/10 text-[var(--electric-blue)] font-bold px-4 py-2 rounded-full text-xs uppercase tracking-widest border border-[var(--electric-blue)] transition-all hover:bg-[var(--electric-blue)] hover:text-white"
                data-industry="b2b">B2B SaaS</button>
            <button
                class="industry-filter-tag bg-[var(--electric-blue)]/10 text-[var(--electric-blue)] font-bold px-4 py-2 rounded-full text-xs uppercase tracking-widest border border-[var(--electric-blue)] transition-all hover:bg-[var(--electric-blue)] hover:text-white"
                data-industry="skincare">Skin Care & Beauty</button>
        </div>
    </div>
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-white/5">
                <tr class="data-table-row">
                    <td class="py-10 px-4 align-top border-r border-white/5 industry-group" data-industry="apparel"
                        rowspan="3">
                ...
                <tr class="data-table-row border-t border-white/10">
                    <td class="py-10 px-4 align-top border-r border-white/5 industry-group" data-industry="fmcg"
                        rowspan="3">
                        <div class="flex items-center gap-3">
                ...
                <tr class="data-table-row border-t border-white/10">
                    <td class="py-10 px-4 align-top border-r border-white/5 industry-group" data-industry="b2b"
                        rowspan="2">
                        <div class="flex items-center gap-3">
                            <span class="material-symbols-outlined"
                                style="color: var(--electric-blue);">business_center</span>
                ...
                <tr class="data-table-row border-t border-white/10">
                    <td class="py-10 px-4 align-top border-r border-white/5 industry-group" data-industry="skincare"
                        rowspan="3">
                        <div class="flex items-center gap-3">
        ...
        <div class="testimonial-wrapper">
            <div class="testimonial-track" id="testimonialTrack">
                ...
                <div class="testimonial-card">
                    <video class="testimonial-video" data-video="public/assets/testimonials/videos/Aadhya.mp4"
                        poster="public/assets/testimonials/thumbnails/Aadhya.jpg" preload="none">
                    </video>
                    <div class="testimonial-content text-white">
                        <h3>AADHYA</h3>
                        <p>Digifyce helped us scale our herbal care brand online. Their performance strategy delivered
                            consistent growth.</p>
                    </div>
                </div>
                ...
                <!-- CARD 2 -->
                <div class="testimonial-card">
                    <video class="testimonial-video" data-video="public/assets/testimonials/videos/Bawse Baby.mp4"
                        poster="public/assets/testimonials/thumbnails/Bawse Baby.jpg" preload="none">
                    </video>
                    <div class="testimonial-content text-white">
                        <h3>BAWSE BABY</h3>
                        <p>The team is creative, responsive, and deeply invested in our growth. Execution quality is
                            excellent.</p>
                    </div>
                </div>
                ...
                <!-- CARD 3 -->
                <div class="testimonial-card">
                    <video class="testimonial-video" data-video="public/assets/testimonials/videos/Aishwaryam.mp4"
                        poster="public/assets/testimonials/thumbnails/Aishwaryam.jpg" preload="none">
                    </video>
                    <div class="testimonial-content text-white">
                        <h3>AISHWARYAM</h3>
                        <p>From strategy to execution, Digifyce exceeded expectations and helped strengthen our online
                            presence.</p>
                    </div>
                </div>

                <div class="testimonial-card">
                    <video class="testimonial-video" data-video="public/assets/testimonials/videos/lushra.mp4"
                        poster="public/assets/testimonials/thumbnails/lushra.png" preload="none">
                    </video>
                    <div class="testimonial-content text-white">
                        <h3>LUSHRA</h3>
                        <p>They are a game-changer in digital marketing. Their strategic approach and execution are
                            unmatched.</p>
                    </div>
                </div>
